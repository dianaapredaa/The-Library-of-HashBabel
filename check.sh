...
TIMEOUT_TIME=(0.000 
0.005 0.007 0.007 0.007 0.007 0.007 0.007 0.007 0.007 0.007
0.007 0.01 0.012 0.02 0.03 0.03 0.5 0.1 0.2 1.2)
...
function checkReadme {
    ...
    if test -f "./README"; then
        ...
        if [[ $(($CHAR_NUMBER)) -gt 100 ]]; then
            ...
            echo -e "\tREADME exists <3 [${README_POINTS}p]"
        else
            README_POINTS=0
